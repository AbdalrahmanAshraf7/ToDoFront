...
export default function useEditTaskName() {


const queryClient = useQueryClient();


    async function editName(data:any) {
        return axios.put(`https://to-do-list-nu-beryl-37.vercel.app/api/edittaskname/${data.id}/${data.id2}`,{name:data.name},{
            headers:{
  ...
  return  {taskName:mutation.mutate , data:mutation.data }
}
